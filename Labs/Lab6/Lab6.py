...
m = M31_COM.m # units of 1e10 Msun
...
print(f'The total mass of the M31 bulge is {bulge_total:.2e} Msun')
...
print(f"Bulge Mass = {b_half:.2e} Msun")
...
print(f"Bulge Mass = {bulge_mass[index[0][0]]:.2e} Msun")
...
# YOU ADD HERE
ax.loglog(r_annuli, sigmaM31bulge, linewidth=2, label='Simulated Bulge')
