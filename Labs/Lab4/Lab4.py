...
def hernquist_mass(r,h_a=60*u.kpc, m_halo=1.975): # ADD m_halo=??
    ...
    a = m_halo*1e12*u.Msun # constants, correct units
    b = r**2/(r+h_a)**2

    mass = a*b # hernquist mass profile
    
    return mass

print(f"The mass of the Milky Way within 50 kpc is {hernquist_mass(50*u.kpc):.2e}")
print(f"The mass of the Milky Way within the edge of the halo is {hernquist_mass(260*u.kpc):.2e}")
# ## #2
# 
...
# Dark Matter Mass
m_dm = hernquist_mass(50*u.kpc)

# Total Mass within 50 kpc
mass_MW50 = m_dm + mdisk + mbulge
print(f"The total mass of the Milky Way within 50 kpc is {mass_MW50:.2e}")
...
sizeL = 18.5*u.kpc # observed radius of LMC
# Mackey+16
distL = 50*u.kpc # distance of LMC from MW

LMC_jacobiM = jacobi_mass(sizeL,distL,mass_MW50)
print(f"The minimum mass of the LMC to maintain its radius of 18.5 kpc is {LMC_jacobiM:.2e}")
...
# 
# Since we have a factor of 4 in the denominator instead of 2, the required LMC mass 
# to maintain a radius of 18.5 kpc would be a factor of 2 larger under the point mass assumption.
...
print(f"The ratio of the minimum mass of the LMC to its stellar mass is {LMC_jacobiM/LMC_mstar:.2f}")