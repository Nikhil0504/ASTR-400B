...
M31_COM_halo = CenterOfMass('../../Data/M31_469.txt', 1)

MW_COM_bulge = CenterOfMass('../../Data/MW_469.txt', 3)
MW_COM_disk = CenterOfMass('../../Data/MW_469.txt', 2)
MW_COM_halo = CenterOfMass('../../Data/MW_469.txt', 1)
...
MW_COM_p_halo = MW_COM_halo.COM_P(0.1)
...
# bulge_mass = M31_mass.massEnclosed(3, r_annuli).value + M31_mass.massEnclosed(2, r_annuli).value + M31_mass.massEnclosed(1, r_annuli).value
